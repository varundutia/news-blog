...
const stats = [
  {
    ...
    sub: "searches end without a click, per Digital Applied",
...
const furtherReading = [
  ...
  {
    label: "Google — A new way to explore the web with AI Mode in Chrome",
    href: "https://blog.google/products-and-platforms/products/search/ai-mode-chrome/",
  },
  {
    label: "Digital Applied — 60% Zero-Click Searches",
    href: "https://www.digitalapplied.com/blog/60-percent-searches-zero-click-crisis-2026-seo-strategy",
  },
  {
    label: "TechCrunch — Google now lets you explore the web side-by-side with AI Mode",
    href: "https://techcrunch.com/2026/04/16/google-now-lets-you-explore-the-web-side-by-side-with-ai-mode/",
  },
  {
    label: "Axel Bruns — Gatewatching and News Curation",
    href: "https://snurb.info/Gatewatching",
  },
  {
    label: "Klaus Meier — Transparency in Journalism",
    href: "https://www.researchgate.net/publication/357834352_TRANSPARENCY_IN_JOURNALISM_Credibility_and_trustworthiness_in_the_digital_future",
  },
];
